...
export const AppProvider = (props: { children: any }) => {
    ...
    */
    ...
    return (
        <AppContext.Provider value={{ currentWalletAddress, setCurrentWalletAddress, key, setKey, email, setEmail, userInfo, setUserInfo, nfts, setNfts, setLoggedin, loggedin, password, setPassword }}>
            {props.children}
        </AppContext.Provider >
    )
};
